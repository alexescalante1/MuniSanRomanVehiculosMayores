...
export async function GetLoginAuthFn(url: string, method: string, params: IInicializacionDT.GetLoginAuthRequest): Promise<IInicializacionDT.GetLoginAuthResponse> {
