...
import { BtnRegUsuarios } from "./BtnRegUsuarios";
            ...
            <div className="col-md-12">
              <div className="card card-success">
                ...
                <div className="card-body">
                  <BtnRegUsuarios ActualizarCard={ActualizarCard}/>
                  <DataTableUsuarios actualizar={actualizar} ActualizarCard={ActualizarCard} />
                </div>
              </div>
            </div>
          </div>
